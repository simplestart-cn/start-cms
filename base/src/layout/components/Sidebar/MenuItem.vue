<template>
    <div v-if="item.menu && !item.hidden" class="menu-wrapper" :style="'background-color:' + backgroundColor">
        <template v-if="hasOneShowingChild(item.children, item) && (!onlyOneChild.children||onlyOneChild.noShowingChildren) && item.menu">
