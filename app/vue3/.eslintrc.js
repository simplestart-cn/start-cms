module.exports = {
  ...
  rules: {
    ...
    'template-curly-spacing': [2, 'never'],//不允许${模板字符}大括号内空格
    'yield-star-spacing': [2, 'both'],//强制执行*周围yield*表达式的间距
    'keyword-spacing': [2, { 'before': true, 'after': true }],// 关键字前后必须一个空格
    ...
    'no-dupe-class-members': 2,//对象成员名字不能重复
    'no-empty-pattern': 2,//不能空模式赋值var {a: {}} = foo;
    'no-new-symbol': 2,//不能new Symbol('foo'),这会引发TypeError异常。
    'no-self-assign': 2,//不能赋值自身
    'no-unmodified-loop-condition': 2,//循环中的变量在循环中修改
    ...
    "eqeqeq": [1, "always", { "null": "ignore" }],//必须使用全等
    ...
    "id-length": 0,//变量名长度
    "indent": [2, 4, { 'SwitchCase': 1 }],//4空格缩进风格,switch case为1个
    ...
    "spaced-comment": [1, 'always', { 'markers': ['global', 'globals', 'eslint', 'eslint-disable', '*package', '!', ','] }],//注释风格要不要有空格什么的
    "strict": 2,//使用严格模式
