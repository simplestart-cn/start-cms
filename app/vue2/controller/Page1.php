...
use app\vue2\service\Page1Service;
...
class Page1 extends Controller
{
   /**
    ...
    public function page()
    {
        ...
        $list = Page1Service::getPage($input);
        $this->success($list);
    }
    ...
    public function list()
    {
        ...
        $list = Page1Service::getList($input);
        $this->success($list);
    }
    ...
    public function info()
    {
        ...
        $model = Page1Service::getInfo($input['id']);
        $this->success($model);
    }
    ...
    public function create()
    {
        ...
        $model = Page1Service::create($input);
        if ($model) {
    ...
    public function update()
    {
        ...
        $model = Page1Service::update($input);
        if ($model) {
            $this->success('操作成功', $model);
        } else {
            $this->error('操作失败');
    ...
    public function remove()
    {
        ...
        if (Page1Service::remove($input['id'])) {
            $this->success('操作成功');
        } else {
            $this->error('操作失败');
        }
    ...
    public function updateList()
    {
        ...
        if (Page1Service::saveAll($input['list'], ['status'])) {
            $this->success('操作成功');
        } else {
            $this->error('操作失败');
        }
    ...
    public function removeList()
    {
        ...
        if (Page1Service::remove($input['list'])) {
            $this->success('操作成功');
        } else {
            $this->error('操作失败');
        }
    ...
    public function importList()
    {
        ...
        $data = Page1Service::import($input['list'], ['title']);
        if ($data) {
    ...
    public function exportList()
    {
        ...
        $data = Page1Service::getPage($input);
        $this->success($data);
    }
}
